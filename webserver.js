    ...
    function serverStart() {
        ...
        for (var i in parent.config.domains) {
            ...
            obj.app.get(url+'main-info',(req,res)=>{
                try {
                    obj.db.file.find({type:{$in:['lastconnect','mesh','node','sysinfo','user']}},(err,docs)=>{
                        if(err){
                            return res.json({
                                ok:false,
            ...
            //** ### DISPOSITIVOS ###
            obj.app.get(url+'devices',(req,res)=>{
                try {
            ...
            //** ### DISPOSITIVO ÚNICO ###
            obj.app.get(url+'device/:id',(req,res)=>{
                if('id' in req.params == false || req.params.id == '' || 'id' in req.params == undefined ){
                    return res.json({
                        ok:false,
                ...
                try {
                    obj.db.file.find({
                        ...
                        if(docs.length == 0){
                            return res.json({
                                ok:false,
                                message:'No se encontró dispositivo'
                            })
                        }
            ...
            //** ### GRUPOS ###
            obj.app.get(url+'groups',(req,res)=>{
                try {
            ...
            //** ### GRUPO ÚNICO ###
            obj.app.get(url+'group/:id',(req,res)=>{
                if('id' in req.params == false || req.params.id == '' || 'id' in req.params == undefined ){
                    return res.json({
                        ok:false,
                        message:'Debe proporcionar un id del grupo'
                    })
                }
                const {id} = req.params;
                try {
                    obj.db.file.find({
                        ...
                        let mesh = docs.find(d=>d.type=='mesh');
                        let nodes = docs.filter(d=>d.type=='node');
